...
router.put('/:id', adminOnly, async (req, res) => {
  try {
    ...
    const update = {
      ...
      ...(sociedadesConciliacion !== undefined && { sociedadesConciliacion: Array.isArray(sociedadesConciliacion) ? sociedadesConciliacion : [] }),
    };
