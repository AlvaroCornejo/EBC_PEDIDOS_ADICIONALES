...
router.put('/:id', adminOnly, async (req, res) => {
  try {
    ...
    const update = {
      ...
      ...(rolCambioReceta !== undefined && { rolCambioReceta: Array.isArray(rolCambioReceta) ? rolCambioReceta : [] }),
